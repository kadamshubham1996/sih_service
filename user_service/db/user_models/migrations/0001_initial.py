# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-03-24 08:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.DateTimeField(default=datetime.datetime(2018, 3, 24, 8, 54, 1, 969175))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'Viewed', b'Viewed'), (b'Processing', b'Processing'), (b'Done', b'Done')], default=None, max_length=124)),
            ],
        ),
        migrations.CreateModel(
            name='Connection',
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2018, 3, 24, 8, 54, 1, 966004))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('login_time', models.DateTimeField(default=datetime.datetime(2018, 3, 24, 8, 54, 1, 967280))),
                ('auth_token', models.CharField(default=b'e755555a-8338-4c1a-9d0f-c917527c2730', max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_time', models.DateTimeField(default=datetime.datetime(2018, 3, 24, 8, 54, 1, 968669))),
            ],
        ),
        migrations.CreateModel(
            name='User',
