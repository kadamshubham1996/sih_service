...
def send_pdf(billing_object):
    print billing_object.user
    username = billing_object.user.username
    month = billing_object.month
    ...
    #c.drawString(250,600,str(billing_object.user.connection.customer_id))
    c.drawString(20, 550, "Name:")
    #c.drawString(250,550,str(billing_object.user.connection.name))
